...
async function triggerSearch() {
    ...
    try {
        ...
        matches.sort((a, b) => {
            const dateA = parseStatementDate(a['Ngày']);
            const dateB = parseStatementDate(b['Ngày']);
            return dateB - dateA;
        });
...
/**
 * Parses DD/MM/YYYY date strings into timestamps for sorting.
...
function parseStatementDate(dateStr) {
    ...
    // Fallback if Date format is ISO or valid string
